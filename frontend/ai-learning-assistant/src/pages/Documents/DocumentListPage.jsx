...
const DocumentListPage = () => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.error(error.message || "Failed to delete docuemnt")
    } finally {
      setDeleting(false);
    }
  };
      ...
      return (
        <div className='flex items-center justify-center min-h-[400px]'>
          <div className='text-center max-w-md'>
            ...
            <p className='dtext-sm text-slate-500 mb-6'>
              Get started by uploading your first PDF document to begin learning.
            </p>
            <button 
              onClick={() => setIsUploadModalOpen(true)}
              className='inline-flex items-center gap-2 px-6 py-3 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 hover:shadow-xl hover:shadow-emerald-500/30 active:scale-[0.98]'
            >
          ...
          <div className='relative w-full max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8'>
            ...
            <div className='mb-6'>
              ...
              <p className='text-sm text-slate-500 mt-1'>
                  Add a PDF Document your library
              </p>
            </div>
                ...
                <div className='space-y-2'>
                  ...
                  <div className='relative border-2 border-dashed border-slate-300 rounded-xl bg-slate-50/50 hover:border-emerald-400 hover:bg-emerald-50/30 transition-all duration-200'>
                    ...
                    <div className='flex flex-col items-center justify-center py-10 px-6'>
                      ...
                      <p className='text-xs text-slate-500'>PDF upto 10 MB</p>
                    </div>  
                  </div>
                </div>
