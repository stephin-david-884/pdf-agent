          ...
          <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10'>
            ...
            <div className="space-y-5">
              ...
              <div className='space-y-2'>
               ...
               <button
                ...
                disabled={loading}
                className='group relative w-full h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 active:scale-[0.98] text-white text-sm font-semibold rounded-xl transition-all duration-200 focus:oultine-none focus:ring-4 focus:ring-emerald-500/20 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100 shadow-lg shadow-emarald-500/25 overflow-hidden'
               >
            ...
            <div className='mt-8 pt-6 border-t border-slate-200/60'>
              <p className='text-center text-sm text-slate-600'>
                  ...
                  <Link to='/register' className='font-semi-bold  text-emerald-600 hover:text-emerald-700 transition-colors duration-200'>
                    Signup
                  </Link>
              </p>
            </div>        
